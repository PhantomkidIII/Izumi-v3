...
module.exports = {
  ...
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/Y0pLkKX.jpeg",
  CAPTION: process.env.CAPTION || "Iᴢᴜᴍɪ",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "Eypz God",
  BOT_NAME: process.env.BOT_NAME || "ALYA",
  SUDO: process.env.SUDO || "2348100835767",
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "ALYA,❤️",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/Y0pLkKX.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "ALYA",
  AUTHOR: process.env.AUTHOR || "ALYA",
